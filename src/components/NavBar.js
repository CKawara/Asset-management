          ...
          <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
            ...
            >
              <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                ...
                <NavLink className="px-4 py-2 flex items-center text-xs uppercase font-bold leading-snug text-dark hover:opacity-75" to='/home'>Assets</NavLink>
                </li>
                <li className="nav-item">
                <NavLink className="px-4 py-2 flex items-center text-xs uppercase font-bold leading-snug text-dark hover:opacity-75" to='/dashboard'>Dashboard</NavLink>
                </li>
                <li className="nav-item">
                <p className="px-4 flex items-center text-xs  font-bold leading-snug text-dark hover:opacity-75">Name <br/> Role</p>
                </li>
